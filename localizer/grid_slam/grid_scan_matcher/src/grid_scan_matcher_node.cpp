...
static std::string __load_file_path("/home/ubuntu/catkin_ws2/src/Autonomous_Mobile_Robot-master/map/simulation/grid");
...
int main(int argc, char **argv)
{
  ...
  __correction_x = __init_x;
  __correction_y = __init_y;
  __correction_theta = __init_theta;
  __correction_tf.setOrigin(tf::Vector3(__correction_x, __correction_y, 0.0));
  tf::Quaternion correction_q;
  correction_q.setRPY(0, 0, __correction_theta);
  __correction_tf.setRotation(correction_q);
