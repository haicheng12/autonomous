...
public:
  ...
  ProbabilityGridMap(const double _cell_size = 0.05, const double _x_min = -20.0, const double _x_max = 20.0,
                     ...
                     const double _prob_hit = 0.51, const double _prob_miss = 0.49, const double _prob_fix_threshold = 0.95) : BaseGridMap(PROB_INIT_VAL, _cell_size, _x_min, _x_max, _y_min, _y_max)
  {
