...
public:
  RRTStarUsingPotential(const int _iteration = 5000, const double _step = 0.1,
                        ...
                        const double _improvement_amout = 0.01, const double _potential_gain = 0.005) : RRTStar(_iteration, _step, _r_param, _goal_select_prob, _use_informed_rrt, _time_out, _improvement_amout)
  {
